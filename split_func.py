...
# def split():
#     """
#     定义闭包，让所有截取内容都存入content_pick列表内
#     :return: 返回函数体db_pick_content和host_pick_content(
#     """
#     content_pick = []

# 截取两个关键字之间的内容，---> 截取有关数据库的巡检信息
def db_content(start_flg, end_flg, secstart_flg, secend_flg):
    """
    定义截取数据库截取信息的函数
...
def host_content(secstart_flg, secend_flg,
    ...
    try:
        ...
        # file_sys_space = file_sys_space[1:]
        # 截取cpu，内存，io的巡检信息
