...
content.append(file_jfx1)
content.append(cpu_jfx1)
content.append(mem_jfx1)
content.append(io_jfx1)
file_jfx2, cpu_jfx2, mem_jfx2, io_jfx2 = host_pick_content('WLWJFX2', 'WLWJFX3')
content.append(file_jfx2)
content.append(cpu_jfx2)
content.append(mem_jfx2)
content.append(io_jfx2)
file_jfx3, cpu_jfx3, mem_jfx3, io_jfx3 = host_pick_content('WLWJFX3', 'WLWJFX4')
content.append(file_jfx3)
content.append(cpu_jfx3)
content.append(mem_jfx3)
content.append(io_jfx3)
file_jfx4, cpu_jfx4, mem_jfx4, io_jfx4 = host_pick_content('WLWJFX4', 'WLWJFX5')
content.append(file_jfx4)
content.append(cpu_jfx4)
content.append(mem_jfx4)
content.append(io_jfx4)
file_jfx5, cpu_jfx5, mem_jfx5, io_jfx5 = host_pick_content('WLWJFX5', 'WLWJFX6')
content.append(file_jfx5)
content.append(cpu_jfx5)
content.append(mem_jfx5)
content.append(io_jfx5)
file_jfx6, cpu_jfx6, mem_jfx6, io_jfx6 = host_pick_content('WLWJFX6', 'WLWDXX1')
content.append(file_jfx6)
content.append(cpu_jfx6)
content.append(mem_jfx6)
content.append(io_jfx6)
file_dxx1, cpu_dxx1, mem_dxx1, io_dxx1 = host_pick_content('WLWDXX1', 'WLWDXX2')
content.append(file_dxx1)
content.append(cpu_dxx1)
content.append(mem_dxx1)
content.append(io_dxx1)
file_dxx2, cpu_dxx2, mem_dxx2, io_dxx2 = host_pick_content('WLWDXX2', 'WLWBYX1')
content.append(file_dxx2)
content.append(cpu_dxx2)
content.append(mem_dxx2)
content.append(io_dxx2)
file_byx1, cpu_byx1, mem_byx1, io_byx1 = host_pick_content('WLWBYX1', 'WLWBYX2')
content.append(file_byx1)
content.append(cpu_byx1)
content.append(mem_byx1)
content.append(io_byx1)
file_byx2, cpu_byx2, mem_byx2, io_byx2 = host_pick_content('WLWBYX2', 'WLWCCX1')
content.append(file_byx2)
content.append(cpu_byx2)
content.append(mem_byx2)
content.append(io_byx2)
file_ccx1, cpu_ccx1, mem_ccx1, io_ccx1 = host_pick_content('WLWCCX1', 'WLWCCX2')
content.append(file_ccx1)
content.append(cpu_ccx1)
content.append(mem_ccx1)
content.append(io_ccx1)
file_ccx2, cpu_ccx2, mem_ccx2, io_ccx2 = host_pick_content('WLWCCX2', 'WLWCCX3')
content.append(file_ccx2)
content.append(cpu_ccx2)
content.append(mem_ccx2)
content.append(io_ccx2)
file_ccx3, cpu_ccx3, mem_ccx3, io_ccx3 = host_pick_content('WLWCCX3', 'wlwjs7')
content.append(file_ccx3)
content.append(cpu_ccx3)
content.append(mem_ccx3)
content.append(io_ccx3)
file_js7, cpu_js7, mem_js7, io_js7 = host_pick_content('wlwjs7', 'wlwjs8')
content.append(file_js7)
content.append(cpu_js7)
content.append(mem_js7)
content.append(io_js7)
file_js8, cpu_js8, mem_js8, io_js8 = host_pick_content('wlwjs8', 'WLWJS1')
content.append(file_js8)
content.append(cpu_js8)
content.append(mem_js8)
content.append(io_js8)
file_JS1, cpu_JS1, mem_JS1, io_JS1 = host_pick_content('WLWJS1', 'WLWJS2')
content.append(file_JS1)
content.append(cpu_JS1)
content.append(mem_JS1)
content.append(io_JS1)
file_JS2, cpu_JS2, mem_JS2, io_JS2 = host_pick_content('WLWJS2', 'WLWJS4')
content.append(file_JS2)
content.append(cpu_JS2)
content.append(mem_JS2)
content.append(io_JS2)
file_JS4, cpu_JS4, mem_JS4, io_JS4 = host_pick_content('WLWJS4', 'WLWJS5')
content.append(file_JS4)
content.append(cpu_JS4)
content.append(mem_JS4)
content.append(io_JS4)
file_JS5, cpu_JS5, mem_JS5, io_JS5 = host_pick_content('WLWJS5', 'WLWJKX1')
content.append(file_JS5)
content.append(cpu_JS5)
content.append(mem_JS5)
content.append(io_JS5)
file_JKX1, cpu_JKX1, mem_JKX1, io_JKX1 = host_pick_content('WLWJKX1', 'WLWJKX2')
content.append(file_JKX1)
content.append(cpu_JKX1)
content.append(mem_JKX1)
content.append(io_JKX1)
file_JKX2, cpu_JKX2, mem_JKX2, io_JKX2 = host_pick_content('WLWJKX2', 'WLWJKX3')
content.append(file_JKX2)
content.append(cpu_JKX2)
content.append(mem_JKX2)
content.append(io_JKX2)
file_JKX3, cpu_JKX3, mem_JKX3, io_JKX3 = host_pick_content('WLWJKX3', 'WLWJKX4')
content.append(file_JKX3)
content.append(cpu_JKX3)
content.append(mem_JKX3)
content.append(io_JKX3)
file_JKX4, cpu_JKX4, mem_JKX4, io_JKX4 = host_pick_content('WLWJKX4', 'WLWJKX5')
content.append(file_JKX4)
content.append(cpu_JKX4)
content.append(mem_JKX4)
content.append(io_JKX4)
file_JKX5, cpu_JKX5, mem_JKX5, io_JKX5 = host_pick_content('WLWJKX5', 'check connection')
content.append(file_JKX5)
content.append(cpu_JKX5)
content.append(mem_JKX5)
content.append(io_JKX5)

# PSMS数据库
cell_PSMSindex = db_pick_content('PSMSDB1', 'CBBSDB3', 'checkindex', 'checkconection')
content.append(cell_PSMSindex)
cell_PSMSconection = db_pick_content('PSMSDB1', 'CBBSDB3', 'checkconection', 'checktablespace')
content.append(cell_PSMSconection)
cell_PSMStablesp = db_pick_content('PSMSDB1', 'CBBSDB3', 'checktablespace', 'checktablepartition')
content.append(cell_PSMStablesp)
cell_PSMStablepart = db_pick_content('PSMSDB1', 'CBBSDB3', 'checktablepartition', 'CBBSDB3')
content.append(cell_PSMStablepart)

# #CBBS数据库
cell_CBBSindex = db_pick_content('CBBSDB3', 'check process', 'checkindex', 'checkconection')
content.append(cell_CBBSindex)
cell_CBBSconection = db_pick_content('CBBSDB3', 'check process', 'checkconection', 'checktablespace')
content.append(cell_CBBSconection)
cell_CBBStablesp = db_pick_content('CBBSDB3', 'check process', 'checktablespace', 'checktablepartition')
content.append(cell_CBBStablesp)
cell_CBBStablepart = db_pick_content('CBBSDB3', 'check process', 'checktablepartition', 'check process')
content.append(cell_CBBStablepart)
